document.addEventListener("DOMContentLoaded", () => {
  ...
  function mostrarResultados(cocteles) {
    ...
    cocteles.forEach((coctel) => {
      ...
      divCoctel.setAttribute("data-id", coctel.idDrink);
      ...
      divCoctel.addEventListener("click", () => {
        window.location.href = `detalle.html?id=${coctel.idDrink}`;
    });
    });
  }
  ...
  // Cuando se da click sobre las cards
